...
public class Sequence
{
    ...
    static Sequence()
    {
        ...
        sequence[musicNotationToOffsetSample(interlude2StartBar)] = new MusicObjectInfo("AsteroidField", 0.5f);
        ...
        // Ending
        sequence[musicNotationToOffsetSample(104 + 4)] = new MusicObjectInfo("End", 0.5f);
    }
    ...
    {
        float yRange = yAutomationEndValue - yAutomationStartValue;
        float stepSize = 1f/5f;
        sequence[musicNotationToOffsetSample(startBar)] = new MusicObjectInfo("StarBb2", yAutomationStartValue);
        sequence[musicNotationToOffsetSample(startBar, 4)] = new MusicObjectInfo("StarAb2", yAutomationStartValue + stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 1)] = new MusicObjectInfo("StarBb2", yAutomationStartValue + 2f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 2)] = new MusicObjectInfo("StarEb3", yAutomationStartValue + 3f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 3)] = new MusicObjectInfo("StarC3", yAutomationStartValue + 4f * stepSize * yRange);
    ...
    private static void writeChorusStartingAtBar(int startBar, float yAutomationStartValue, float yAutomationEndValue)
    {
        ...
        sequence[musicNotationToOffsetSample(startBar)] = new MusicObjectInfo("StarBb2", yAutomationStartValue);
        sequence[musicNotationToOffsetSample(startBar, 1, 4)] = new MusicObjectInfo("StarEb3", yAutomationStartValue + stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar, 3)] = new MusicObjectInfo("StarF3", yAutomationStartValue + 2f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar, 3, 4)] = new MusicObjectInfo("StarEb3", yAutomationStartValue + 3f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 1)] = new MusicObjectInfo("StarDb3", yAutomationStartValue + 4f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 1, 1, 4)] = new MusicObjectInfo("StarBb2", yAutomationStartValue + 5f * stepSize * yRange);

        sequence[musicNotationToOffsetSample(startBar + 2)] = new MusicObjectInfo("StarF3", yAutomationStartValue + 6f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 2, 1, 4)] = new MusicObjectInfo("StarAb3", yAutomationStartValue + 7f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 2, 3)] = new MusicObjectInfo("StarF3", yAutomationStartValue + 8f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 2, 3, 4)] = new MusicObjectInfo("StarEb3", yAutomationStartValue + 9f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 3)] = new MusicObjectInfo("StarDb3", yAutomationStartValue + 10f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 3, 1, 4)] = new MusicObjectInfo("StarBb2", yAutomationStartValue + 11f * stepSize * yRange);
        sequence[musicNotationToOffsetSample(startBar + 3, 3)] = new MusicObjectInfo("StarAb2", yAutomationStartValue + 12f * stepSize * yRange);
